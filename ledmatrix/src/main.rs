...
#[used]
pub static PICOTOOL_ENTRIES: [rp_binary_info::entry::Addr; 4] = [
    PROGRAM_NAME.addr(),
    PROGRAM_VERSION.addr(),
    BUILD_DATE.addr(),
    BUILD_ATTRIBUTE.addr(),
];

/// This is the name of our program
static PROGRAM_NAME: rp_binary_info::entry::IdAndString =
    rp_binary_info::program_name(concat!("Framework 16 LED Matrix", "\0"));

const DIRTY: &str = if let Some(true) = built_info::GIT_DIRTY {"dirty"} else {""};

/// This is the version of our program
static PROGRAM_VERSION: rp_binary_info::entry::IdAndString =
    rp_binary_info::version(concat!(env!("CARGO_COMMIT_SHORT_HASH"), "\0"));

/// This is the version of our program
static BUILD_DATE: rp_binary_info::entry::IdAndString =
    rp_binary_info::build_date(built_info::BUILT_TIME_UTC);

static BUILD_ATTRIBUTE: rp_binary_info::entry::IdAndString =
    rp_binary_info::custom_string(rp_binary_info::TAG_RASPBERRY_PI, rp_binary_info::ID_RP_PROGRAM_BUILD_ATTRIBUTE, DIRTY);
